...
| 25 | ✅ | CI Hardening ([PR #25](https://github.com/anillahane/Territory/pull/25)) | `.github/workflows/ci.yml`, add `.github/workflows/deploy.yml` | Fail on high vulnerabilities, add image scanning, Dependabot, and real deploy workflow or remove stubs. |
